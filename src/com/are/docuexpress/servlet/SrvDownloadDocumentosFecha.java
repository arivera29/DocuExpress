 ...
 * @author Aimer
 */
@WebServlet("/SrvDownloadDocumentosFecha")
public class SrvDownloadDocumentosFecha extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (tfecha.equals("1")) {
                sql += "AND CONVERT(date,fechaCarga) BETWEEN  CONVERT(date,?) AND CONVERT(date,?) ";
            }
           ...
           out.println(fila);
            ...
            if (conexion != null) {
                try {
                    ...
                    Logger.getLogger(SrvDownloadDocumentosFecha.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        }
