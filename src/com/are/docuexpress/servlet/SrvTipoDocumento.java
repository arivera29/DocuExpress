...
import com.are.docuexpress.controlador.ControladorTipoDocumento;
 ...
 * @author Aimer
 */
@WebServlet("/SrvTipoDocumento")
public class SrvTipoDocumento extends HttpServlet {
            ...
            try {
                ...
                */
                if (operacion.equals("add")) { 
                    ...
                    ControladorTipoDocumento controlador = new ControladorTipoDocumento(conexion);
                ...
                */
                if (operacion.equals("list")) { 
                    conexion = new db();
                    ControladorTipoDocumento controlador = new ControladorTipoDocumento(conexion);
                    ArrayList<TipoDocumento> lista = controlador.list();
                    ...
                    for (TipoDocumento tipo : lista) {
                        ...
                        out.println("<td><a class='btn btn-primary bt-sm' href='mod_tipo_documento.jsp?codigo=" + tipo.getCodigo() + "'>Editar</a></td>");
                        out.println("</tr>");
                    }
                    out.println("</tbody>");
                    out.println("</table>");
                ...
                if (conexion != null) {
                    try {
                        ...
                        Logger.getLogger(SrvTipoDocumento.class.getName()).log(Level.SEVERE, null, ex);
                    }
                }
            }
