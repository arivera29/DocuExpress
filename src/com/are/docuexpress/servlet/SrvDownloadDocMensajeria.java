 ...
 * @author Aimer
 */
@WebServlet("/SrvDownloadDocMensajeria")
public class SrvDownloadDocMensajeria extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String sql = "SELECT documentos.nic AS NIC, "
                    ...
                    + "AND CONVERT(datetime,archivos.fecha) BETWEEN  CONVERT(datetime,?) AND CONVERT(datetime,?) ";
           ...
           out.println(fila);
            ...
            if (conexion != null) {
                try {
                    ...
                    Logger.getLogger(SrvDownloadDocMensajeria.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        }
