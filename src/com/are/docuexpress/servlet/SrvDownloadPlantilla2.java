 ...
 * @author Aimer
 */
@WebServlet("/SrvDownloadPlantilla2")
public class SrvDownloadPlantilla2 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("FECHA" +  separador
                    ...
                    + "CONSECUTIVO" + separador 
                    + "NOMBRE DOCUMENTO"+ separador 
                    + "FECHA CORRESPONDENCIA"+ separador 
                    + "MUNCIPIO" + separador 
                    + "BARRIO"+ separador 
                    + "VIA" + separador 
                    + "CRUCERO" + separador 
            ...
            while (rs.next()) {
                ...
                fila += parseString(rs.getString("codDocumento")) + separador;
                ...
                fila += parseString(rs.getString("fecha")) + separador;
            ...
            if (conexion != null) {
                try {
                    ...
                    Logger.getLogger(SrvDownloadPlantilla2.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        }
