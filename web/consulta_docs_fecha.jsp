...
<html>
    <head>
        ...
        <title>Consulta Documentos Fecha</title>
    ...
    <body>
        ...
        <div class="container">
            <h3>Consulta Documentos x Fecha</h3>
            <hr>
            <form action="SrvDownloadDocumentosFecha" name="form1" id="form1" role="form">
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-xs-4">
                            <label for="tfecha">Tipo fecha</label>
                            <select class="form-control input-sm" name="tfecha" id="tfecha">
                                <option value="1">Fecha Carga Documento</option>
                            </select>
                        </div>
