        ...
        <div class="container">
            ...
            <form action="" name="form1" id="form1" role="form">
                <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-xs-4">
                            <label for="estado">Tipo fecha</label>
                            <select class="form-control input-sm" name="tfecha" id="tfecha">
                                <option value="1">Fecha Carga Documento</option>
                                <option value="2">Fecha Carga Guía</option>
                                <option value="3">Fecha Gestion Guia</option>
                                <option value="4">Fecha Carga Imagen Guia</option>
