...
<script type="text/javascript">
	...
	function list() {
		...
		$("#list").load("SrvTipoDocumento?operacion=list",function() {
...
<p>
	Esta vista permite agregar el registro de Tipos de docuementos.  Debe diligenciar la informacion y dar clic en el boton Agregar.
</p>
<div id="info"></div>
