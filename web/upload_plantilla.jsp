        ...
        if (file != null) {
            ...
            try {
                ...
                if (archivo_server.exists()) {
                    ...
                    if (headers.length != 32) { // estan las columnas OK.
                    ...
                    if (!error && idCarga != -1) {
                        ...
                        while (reader.readRecord()) {
                            ...
                            fila++;
                            try {
                                String tipoDocumento = reader.get(3);
                                ...
                                documento.setNic(reader.get(1));
                                documento.setNumero(reader.get(2));
                                documento.setNombre(tipoDocumento);
                                documento.setMunicipio(reader.get(4));
                                documento.setBarrio(reader.get(5));
                                documento.setVia(reader.get(6));
                                documento.setCrucero(reader.get(7));
                                documento.setPlaca(reader.get(8));
                                documento.setReclamante(reader.get(9));
                                documento.setTelefono(reader.get(10));
                                documento.setProceso(reader.get(31)); // Identificador del proceso
                                documento.setCodigo(reader.get(30));
