...
<html>
        ...
        <script type="text/javascript">
            ...
            function procesar(resultado) {
                ...
                if (resultado != 'OK') {
                    ...
                    $("#info").html("<img src=\"images/ok.gif\">Empresa agregada correctamente");
                    $("#nombre").val("");
                    list();
                }
            ...
            function list() {
                ...
                $("#list").load("SrvAreaGestion?operacion=list", function () {
    ...
    <body onload="list()">
        ...
        <div class="container">
            <h3>Area de Gestion</h3>
            <p>
                Esta vista permite agregar el registro de las Areas de Gestion de las no conformidades.  Debe diligenciar la informacion y dar clic en el boton Agregar.
            </p>
            <div id="info"></div>
