...
<%
    ...
    db conexion = new db();
    String sql = "SELECT archivo_impresion.*, tipoArchivo.nomTipoArchivo, (SELECT count(*) FROM historial_descargas WHERE id_doc_impresion = archivo_impresion.id) AS cnt_download "
...
<table class="table table-striped" id="tabla">
    ...
    <tr>
        ...
        <td>
            ...
            <button type="button" onclick="javascript:eliminar(<%= rs.getInt("id") %>);" class="btn btn-primary btn-sm">Eliminar</button>
            <% } %>
