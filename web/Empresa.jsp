...
<script type="text/javascript">
	...
	function list() {
		...
		$("#list").load("SrvEmpresa?operacion=list",function() {
...
<h3>Empresas</h3>
<p>
	Esta vista permite agregar el registro de Empresas.  Debe diligenciar la informacion y dar clic en el boton Agregar.
</p>
<div id="info"></div>
