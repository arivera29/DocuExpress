...
<html>
    <head>
        ...
        <title>Subir Archivo Guias</title>
    ...
    <body>
        ...
        <div class="container">
            <h3><img src="images/upload.png">Subir archivo Guias</h3>
            <p>
                Descargar plantilla. <a href="plantillas/FORMATO_CARGA_GUIAS.xlsx" title="Descargar plantilla"><img src="images/download.png"></a>
            </p>
            <p>
            ...
            <form action="" name="form1" id="form1" role="form">
                <div class="form-group">
                    <div class="row">
                        <div class="col-xs-4">
                            <label for="archivo">Archivo Guias</label>
    ...
    <script>
        function upload_file(){//Funcion encargada de enviar el archivo via AJAX
				...
				$.ajax({
					url: "upload_guias.jsp",        // Url to which the request is send
