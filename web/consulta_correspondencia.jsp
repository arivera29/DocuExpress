...
<html>
    <head>
        ...
        <title>Consulta de Correspondencia</title>
        ...
        <script>
            function list() {
                ...
                var url = "table_consulta_correspondencia.jsp";
                $("#lista").load(url, {
                    oficina: oficina,
    ...
    <body>
        ...
        <div class="container">
            <h3><img src="images/print.png">Consulta de Correspondencia</h3>
            <hr>
            <form action="SrvDownloadRpCorrespondencia" name="form1" id="form1" role="form">
                <div class="form-group">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-3">
                            ...
                            <select name="tipoFecha" id="tipoFecha" class="form-control input-sm">
                                <option value="1">Fecha Carga</option>
                                <option value="2">Fecha Impresion</option>
                            </select>
                        </div>
                        <div class="col-xs-3">
