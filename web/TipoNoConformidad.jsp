...
<html>
    <head>
        ...
        <title>Tipos de No Conformidad</title>
        ...
        <script type="text/javascript">
            ...
            function list() {
                ...
                $("#list").load("SrvTipoNoConformidad?operacion=list", function () {
    ...
    <body onload="list()">
        ...
        <div class="container">
            <h3>Tipos de No Conformidad</h3>
            <p>
                Esta vista permite agregar el registro de Tipos de No Conformidad.  Debe diligenciar la informacion y dar clic en el boton Agregar.
            </p>
            <div id="info"></div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-2">
                            ...
                            <select name="responsable" id="responsable" class="form-control input-sm">
                                <option value="1">Central de escritos</option>
                                <option value="2">Operador Mensajeria</option>
                            </select>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-xs-4">
                            ...
                            <input type="text" name="correo1" id="correo1" class="form-control input-sm" placeholder="Ingrese correo Notificacion">
                        </div>
                        <div class="col-xs-4">
                            <label for="correo2">Correo Notificacion 2</label>
                            <input type="text" name="correo2" id="correo2" class="form-control input-sm" placeholder="Ingrese correo Notificacion">
                        </div>
                        <div class="col-xs-2">
