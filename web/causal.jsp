...
<script type="text/javascript">
	...
	function list() {
		...
		$("#list").load("SrvCausal?operacion=list",function() {
...
<div class="container">
<h3>Causal de devolucion</h3>
<p>
	Esta vista permite agregar el registro de Causal de devolucion.  Debe diligenciar la informacion y dar clic en el boton Agregar.
</p>
<div id="info"></div>
