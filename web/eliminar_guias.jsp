...
<html>
    ...
    <body>
        ...
        <div class="container">
            <h3><img src="images/upload.png">Eliminar guias de procesos</h3>            
            <p>
            ...
            <form action="" name="form1" id="form1" role="form">
                ...
                <div class="form-group">
                    <button type="button" onclick="javascript:upload_file();" name="cmd_subir" id="cmd_subir" class="btn btn-primary btn-sm">Procesar archivo</button>
                </div>
    ...
    <script>
        function upload_file(){//Funcion encargada de enviar el archivo via AJAX
				...
				$.ajax({
					url: "proceso_del_guias.jsp",        // Url to which the request is send
