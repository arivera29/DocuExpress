...
<%
	...
	db conexion = new db();
	ControladorDepartamento manejador = new ControladorDepartamento(conexion);
	if (!manejador.find(codigo)) {
		response.sendRedirect("departamento.jsp");
		return;
	}
	
	Departamento departamento = manejador.getDepartamento();
...
<p>
	Esta vista permite modificar el registro de Departamento.  Debe diligenciar la informacion y dar clic en el boton Guardar.
</p>
<div id="info"></div>
		...
		<div class="form-group">
			<div class="row">
				<div class="col-xs-2">
					...
					<input type="text" name="codigo" id="codigo" class="form-control input-sm" placeholder="Ingrese codigo" value="<%= departamento.getCodigo()  %>">
				</div>
				<div class="col-xs-4">
					<label for="nombre">Nombre</label>
					<input type="text" name="nombre" id="nombre" class="form-control input-sm" placeholder="Ingrese descripcion" value="<%= departamento.getNombre()  %>">
				</div>
